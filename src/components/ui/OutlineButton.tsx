...
export default function OutlineButton({
  ...
  return (
    <button
      type={type}
      onClick={onClick}
      className={`relative group overflow-hidden border-2 border-[var(--bg)] text-[var(--bg)] px-6 py-3 rounded-full transition-all duration-300 font-medium hover:border-[var(--primary)] ${className}`}
    >
